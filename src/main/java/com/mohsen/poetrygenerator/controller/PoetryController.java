package com.mohsen.poetrygenerator.controller;

import com.mohsen.poetrygenerator.dto.PoetryDto;
import com.mohsen.poetrygenerator.service.PoetryService;
...
public class PoetryController {
    ...
    @GetMapping("/robotHaiku")
    public ResponseEntity<String> generateHaiku() {
        return ResponseEntity.ok(poetryService.getRobotHaiku());
    }
